...
`faraday-delay-template` branch — the diffuse sky as a delay-space **shape**
template (`dispersion.py`, `noise.py`, the four `step5_*` scripts). That is
